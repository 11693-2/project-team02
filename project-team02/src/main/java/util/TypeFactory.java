...
public class TypeFactory {
	...
	public static Question createQuestion(JCas jcas, String id, String source, String questionType, String text) {
	...
	public static Token createToken(JCas jcas, int begin, int end, List<Token> arguments, List<String> argumentLabels,
			Token parse, String semanticType, String partOfSpeech, String lemmaForm, boolean isMainReference,
	...
	public static Token createToken(JCas jcas, int begin, int end) {
		return createToken(jcas, begin, end, new ArrayList<>(), new ArrayList<>(), TypeConstants.PARSE_UNKNOWN,
	...
	public static Concept createConcept(JCas jcas, String name, List<String> uris, List<ConceptMention> mentions) {
	...
	public static ConceptMention createConceptMention(JCas jcas, int begin, int end, String name, List<String> ids) {
		ConceptMention ret = new ConceptMention(jcas);
		ret.setBegin(begin);
		ret.setEnd(end);
	...
	public static Entity createEntity(JCas jcas, String name, List<String> uris, List<EntityMention> mentions) {
	...
	public static EntityMention createEntityMention(JCas jcas, int begin, int end, String name, List<String> ids) {
		EntityMention ret = new EntityMention(jcas);
		ret.setBegin(begin);
		ret.setEnd(end);
	...
	public static Relation createRelation(JCas jcas, String name, List<String> uris, List<RelationMention> mentions) {
	...
	public static RelationMention createRelationMention(JCas jcas, int begin, int end, Relation relation) {
	...
	public static RelationMention createRelationMention(JCas jcas, int begin, int end, String name, List<String> uris) {
		RelationMention ret = new RelationMention(jcas);
		ret.setBegin(begin);
		ret.setEnd(end);
	...
	public static Triple createTriple(JCas jcas, String subject, String predicate, String object, boolean isObjUri) {
	...
	public static AtomicQueryConcept createAtomicQueryConcept(JCas jcas, List<String> namedEntityTypes,
	...
	public static AtomicQueryConcept createAtomicQueryConcept(JCas jcas, String namedEntityType,
			TypeConstants.ConceptType conceptType, String text, String originalText) {
		return createAtomicQueryConcept(jcas, Arrays.asList(namedEntityType), conceptType, text, originalText);
	}

	public static AtomicQueryConcept createAtomicQueryConcept(JCas jcas, TypeConstants.ConceptType conceptType,
			String text, String originalText) {
		return createAtomicQueryConcept(jcas, new ArrayList<>(), conceptType, text, originalText);
	}

	public static ComplexQueryConcept createComplexQueryConcept(JCas jcas, List<String> namedEntityTypes,
			TypeConstants.ConceptType conceptType, QueryOperator operator, List<QueryConcept> operatorArgs) {
	...
	public static ComplexQueryConcept createComplexQueryConcept(JCas jcas, List<String> namedEntityTypes,
			TypeConstants.ConceptType conceptType, QueryOperator operator, QueryConcept... operatorArgs) {
		return createComplexQueryConcept(jcas, namedEntityTypes, conceptType, operator, Arrays.asList(operatorArgs));
	}

	public static ComplexQueryConcept createComplexQueryConcept(JCas jcas, String namedEntityType,
			TypeConstants.ConceptType conceptType, QueryOperator operator, List<QueryConcept> operatorArgs) {
		return createComplexQueryConcept(jcas, Arrays.asList(namedEntityType), conceptType, operator, operatorArgs);
	}

	public static ComplexQueryConcept createComplexQueryConcept(JCas jcas, String namedEntityType,
			TypeConstants.ConceptType conceptType, QueryOperator operator, QueryConcept... operatorArgs) {
		return createComplexQueryConcept(jcas, namedEntityType, conceptType, operator, Arrays.asList(operatorArgs));
	}

	public static ComplexQueryConcept createComplexQueryConcept(JCas jcas, TypeConstants.ConceptType conceptType,
	...
	public static QueryOperator createQueryOperator(JCas jcas, TypeConstants.QueryOperatorName name, List<String> args) {
	...
	public static QueryOperator createQueryOperator(JCas jcas, TypeConstants.QueryOperatorName name, String... args) {
	...
	public static Document createDocument(JCas jcas, String uri, double score, String text, int rank,
			String queryString, String searchId, Collection<CandidateAnswerVariant> candidateAnswers, String title,
			String docId) {
	...
	public static Document createDocument(JCas jcas, String uri, String text, int rank, String queryString,
			String title, String docId) {
		return TypeFactory.createDocument(jcas, uri, TypeConstants.SCORE_UNKNOWN, text, rank, queryString,
				TypeConstants.SEARCH_ID_UNKNOWN, new ArrayList<>(), title, docId);
	}
	...
	public static Document createDocument(JCas jcas, String uri, String docId) {
		return createDocument(jcas, uri, TypeConstants.SCORE_UNKNOWN, TypeConstants.TEXT_UNKNOWN,
				TypeConstants.RANK_UNKNOWN, TypeConstants.QUERY_STRING_UNKNOWN, TypeConstants.SEARCH_ID_UNKNOWN,
				new ArrayList<>(), TypeConstants.TITLE_UNKNOWN, docId);
	}

	public static Document createDocument(JCas jcas, String uri) {
		return createDocument(jcas, uri, TypeConstants.SCORE_UNKNOWN, TypeConstants.TEXT_UNKNOWN,
				TypeConstants.RANK_UNKNOWN, TypeConstants.QUERY_STRING_UNKNOWN, TypeConstants.SEARCH_ID_UNKNOWN,
				new ArrayList<>(), TypeConstants.TITLE_UNKNOWN, TypeConstants.DOC_ID_UNKNOWN);
	}

	public static Passage createPassage(JCas jcas, String uri, double score, String text, int rank, String queryString,
			String searchId, Collection<CandidateAnswerVariant> candidateAnswers, String title, String docId,
			int offsetInBeginSection, int offsetInEndSection, String beginSection, String endSection, String aspects) {
	...
	public static Passage createPassage(JCas jcas, String uri, String text, String docId, int offsetInBeginSection,
		...
		return createPassage(jcas, uri, TypeConstants.SCORE_UNKNOWN, text, TypeConstants.RANK_UNKNOWN,
				...
				TypeConstants.TITLE_UNKNOWN, docId, offsetInBeginSection, offsetInEndSection, beginSection, endSection,
	...
	public static Passage createPassage(JCas jcas, String uri, String text, int offsetInBeginSection,
		...
		return createPassage(jcas, uri, TypeConstants.SCORE_UNKNOWN, text, TypeConstants.RANK_UNKNOWN,
				TypeConstants.QUERY_STRING_UNKNOWN, TypeConstants.SEARCH_ID_UNKNOWN, new ArrayList<>(),
				TypeConstants.TITLE_UNKNOWN, TypeConstants.DOC_ID_UNKNOWN, offsetInBeginSection, offsetInEndSection,
				beginSection, endSection, TypeConstants.ASPECTS_UNKNOWN);
	}

	public static ConceptSearchResult createConceptSearchResult(JCas jcas, Concept concept, String uri, double score,
	...
	public static ConceptSearchResult createConceptSearchResult(JCas jcas, Concept concept, String uri, double score,
			String text, String queryString) {
		return createConceptSearchResult(jcas, concept, uri, score, text, TypeConstants.RANK_UNKNOWN, queryString,
	...
	public static ConceptSearchResult createConceptSearchResult(JCas jcas, Concept concept, String uri) {
		return createConceptSearchResult(jcas, concept, uri, TypeConstants.SCORE_UNKNOWN, TypeConstants.TEXT_UNKNOWN,
				TypeConstants.QUERY_STRING_UNKNOWN);
	}

	public static TripleSearchResult createTripleSearchResult(JCas jcas, Triple triple, String uri, double score,
			String text, int rank, String queryString, String searchId,
			Collection<CandidateAnswerVariant> candidateAnswers) {
	...
	public static TripleSearchResult createTripleSearchResult(JCas jcas, Triple triple, String queryString) {
		return createTripleSearchResult(jcas, triple, TypeConstants.URI_UNKNOWN, TypeConstants.SCORE_UNKNOWN,
				TypeConstants.TEXT_UNKNOWN, TypeConstants.RANK_UNKNOWN, queryString, TypeConstants.SEARCH_ID_UNKNOWN,
				new ArrayList<>());
	}

	public static TripleSearchResult createTripleSearchResult(JCas jcas, Triple triple) {
		return createTripleSearchResult(jcas, triple, TypeConstants.URI_UNKNOWN, TypeConstants.SCORE_UNKNOWN,
				TypeConstants.TEXT_UNKNOWN, TypeConstants.RANK_UNKNOWN, TypeConstants.QUERY_STRING_UNKNOWN,
				TypeConstants.SEARCH_ID_UNKNOWN, new ArrayList<>());
	}

	public static Search createSearch(JCas jcas, String query, List<SearchResult> hitList, AbstractQuery abstractQuery,
			String searchId) {
